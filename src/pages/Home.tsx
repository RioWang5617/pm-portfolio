...
export default function Home() {
  ...
  return (
    <div>
      {/* HERO — Stripe Press style: oversized serif, generous space */}
            ...
            <div className="md:col-span-10">
              ...
              >
                <div className="aspect-[16/9] w-full rounded-sm bg-gradient-to-br overflow-hidden mb-8 relative">
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${featured.cover}`}
                  />
                ...
                <div className="flex items-baseline justify-between gap-6 flex-wrap">
                  ...
                  <span className="text-[0.9rem] text-muted num">
                    {featured.year} · {featured.role}
                  </span>
                </div>
                <p className="mt-3 text-[1.05rem] text-muted max-w-prose">
                  {featured.subtitle}
                </p>
        ...
        <div className="mx-auto max-w-wide px-6 md:px-10 py-24 md:py-32">
          <div className="grid md:grid-cols-12 gap-8">
            ...
            <div className="md:col-span-10">
              ...
              <Link
                to={`/vibecoding/${featuredDemo.slug}`}
                className="group block reveal"
              >
                <div className="border border-line rounded-sm p-8 md:p-12 hover:border-ink transition-colors">
                  ...
                  <p className="text-[1.05rem] text-muted mb-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {featuredDemo.stack.map((s) => (
                      <span
                        key={s}
                        className="text-[0.78rem] px-2.5 py-1 border border-line rounded-full text-muted font-mono"
                      >
                        {s}
                      </span>
                    ))}
              ...
              <div className="mt-10">
                <Link
                  to="/vibecoding"
                  className="text-[0.95rem] text-muted hover:text-ink transition-colors"
                >
        ...
        <div className="mx-auto max-w-wide px-6 md:px-10 py-24 md:py-32">
          <div className="grid md:grid-cols-12 gap-8">
            ...
            <div className="md:col-span-10">
              ...
              <Link
                to="/about"
                className="inline-block mt-10 text-[0.95rem] underline decoration-line underline-offset-[6px] hover:decoration-ink"
              >
                了解更多 →
              </Link>
            </div>
